...
class TVS_Plugin {
    ...
    public function register_blocks() {
        ...
        if ( function_exists( 'register_block_type' ) ) {
            ...
            register_block_type( TVS_PLUGIN_DIR . 'blocks/activity-heatmap/block.json' );

            // Route Weather block
            register_block_type( TVS_PLUGIN_DIR . 'blocks/route-weather/block.json' );
            ...
            register_block_type( TVS_PLUGIN_DIR . 'blocks/activity-stats-dashboard/block.json' );

            // Single Activity Details block
            register_block_type( TVS_PLUGIN_DIR . 'blocks/single-activity-details/block.json' );

            // Activity Timeline block
            register_block_type( TVS_PLUGIN_DIR . 'blocks/activity-timeline/block.json' );

            // Activity Gallery block
            register_block_type( TVS_PLUGIN_DIR . 'blocks/activity-gallery/block.json' );

            // My Favourites block
            register_block_type( TVS_PLUGIN_DIR . 'blocks/my-favourites/block.json' );

            // People's Favourites block
            register_block_type( TVS_PLUGIN_DIR . 'blocks/people-favourites/block.json' );

            // Routes Grid block
            register_block_type( TVS_PLUGIN_DIR . 'blocks/routes-grid/block.json' );
