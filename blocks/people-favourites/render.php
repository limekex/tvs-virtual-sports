<?php
/**
 * People's Favourites Block - Server-side render
 * Shows the most favourited routes across all users
 * 
...
if ( empty( $top_route_ids ) ) {
    echo '<div class="tvs-favourites-block tvs-no-results" style="padding: var(--tvs-space-4); text-align: center;">No favourited routes yet.</div>';
    return;
}
